...
const TERMINAL_LINES = [
  ...
  { output: 'Hariom', delay: 1400 },
  { output: 'BCA Student', delay: 1700 },
  { output: 'Aspiring Developer', delay: 2000 },
  { prompt: 'hariom@portfolio:~$', command: ' status', delay: 2800 },
  { output: '● Learning...', delay: 3400, color: '#00D4FF' },
  { output: '● Building...', delay: 3700, color: '#39FF14' },
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2 glass px-4 py-2 rounded-full border border-primary/20">
                ...
                <span className="font-mono text-xs text-muted-foreground tracking-widest uppercase">Available for Learning</span>
              </div>
            </div>
            ...
            <div>
              ...
              <h1 className="font-display text-hero font-light leading-none tracking-tight text-foreground mb-4">
                Hi, I&apos;m{' '}
                <span className="gradient-text-cyan font-semibold">Hariom</span>
              </h1>
              <p className="text-hero-sm font-display font-light text-muted-foreground leading-tight">
                BCA Student &amp;{' '}
                <span className="text-accent italic">Aspiring Developer</span>
              </p>
            </div>

            {/* Description */}
            <p className="text-base text-muted-foreground leading-relaxed max-w-lg border-l-2 border-primary/30 pl-5">
              Exploring code, building skills, and turning ideas into digital experiences.
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              <a
                href="#journey"
                className="magnetic-btn relative group flex items-center gap-2 bg-primary text-primary-foreground px-7 py-3 rounded-full font-semibold text-sm tracking-wide hover:shadow-lg transition-all duration-300 glow-cyan"
              >
              ...
              <a
                href="#contact"
                className="magnetic-btn flex items-center gap-2 glass border border-primary/30 text-foreground px-7 py-3 rounded-full font-semibold text-sm tracking-wide hover:border-primary/60 transition-all duration-300"
              >
                Let&apos;s Connect
              </a>
            </div>
            ...
            <div className="flex items-center gap-4 pt-2">
              ...
              <a
                ...
                className="glass p-2.5 rounded-xl border border-border hover:border-primary/40 transition-all group"
                aria-label="GitHub"
              >
              ...
              <div className="relative">
                <div className="w-40 h-40 md:w-48 md:h-48 rounded-full overflow-hidden border-2 border-primary/40 shadow-lg" style={{ boxShadow: '0 0 32px rgba(0,212,255,0.18)' }}>
                  <img
                    ...
                    alt="Hariom - panda with laptop avatar illustration"
