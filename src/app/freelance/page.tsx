...
const projects = [
  { title: 'Masonry & Roofing Website', type: 'Business Website Concept', repo: 'pateljiop/Demo', href: 'https://pateljiop.github.io/Demo/', screenshot: 'https://image.thum.io/get/width/1200/crop/900/https://pateljiop.github.io/Demo/' },
  { title: 'Laundry Service Website', type: 'Local Business Concept', repo: 'pateljiop/Laundry-demo', href: 'https://pateljiop.github.io/Laundry-demo/', screenshot: 'https://image.thum.io/get/width/1200/crop/900/https://pateljiop.github.io/Laundry-demo/' },
  { title: 'Roofing Website', type: 'Service Business Concept', repo: 'pateljiop/Roofing-demo', href: 'https://pateljiop.github.io/Roofing-demo/', screenshot: 'https://image.thum.io/get/width/1200/crop/900/https://pateljiop.github.io/Roofing-demo/' },
  { title: 'Property Maintenance Website', type: 'Service Business Concept', repo: 'pateljiop/mek-property-maintenance-demo', href: 'https://pateljiop.github.io/mek-property-maintenance-demo/', screenshot: 'https://image.thum.io/get/width/1200/crop/900/https://pateljiop.github.io/mek-property-maintenance-demo/' },
];
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-background text-foreground">
      ...
      <main>
        ...
        <section id="work" className="bg-card/20 py-24"><div className="mx-auto max-w-6xl px-6"><div className="mb-12"><p className="font-mono text-sm text-primary">SELECTED WORK</p><h2 className="mt-3 text-4xl font-black md:text-5xl">Business website concepts</h2><p className="mt-4 max-w-2xl text-muted-foreground">A few demo projects showing how I approach real-world service businesses. These are presented as concepts, not false client claims.</p></div><div className="grid gap-6 md:grid-cols-2">{projects.map((project) => <article key={project.repo} className="group overflow-hidden rounded-3xl border border-border bg-background/60"><a href={project.href} target="_blank" rel="noreferrer" className="block overflow-hidden bg-muted"><img src={project.screenshot} alt={`${project.title} live website screenshot`} loading="lazy" className="h-56 w-full object-cover object-top transition duration-500 group-hover:scale-[1.02]" /></a><div className="p-6"><p className="font-mono text-xs text-primary">{project.type}</p><h3 className="mt-2 text-2xl font-bold">{project.title}</h3><p className="mt-2 text-sm text-muted-foreground">Responsive business website concept focused on clear services, trust and enquiries.</p><a className="mt-6 inline-flex font-semibold text-primary" href={project.href} target="_blank" rel="noreferrer">View live project →</a></div></article>)}</div></div></section>
