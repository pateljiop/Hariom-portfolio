          ...
          <div className="relative mx-auto grid max-w-7xl items-center gap-14 px-6 pb-24 pt-20 md:px-10 md:pb-32 md:pt-28 lg:grid-cols-[1.1fr_.9fr]">
            <div>
              ...
              <div className="mt-9 flex flex-wrap gap-3">
                ...
                <a href="/#contact" className="rounded-xl border border-border bg-background/60 px-6 py-3.5 font-semibold transition hover:border-primary/50 hover:bg-primary/5">Work with me</a>
              </div>
